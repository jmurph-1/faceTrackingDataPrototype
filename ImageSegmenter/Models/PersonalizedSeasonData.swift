...
struct PersonalizedSeasonData: Codable {
    ...
    /// Metal recommendations for this season
    ...
    init(
        ...
        metals: [MetalRecommendation]? = nil
    ) {
        self.id = id
...
extension PersonalizedSeasonData {
    ...
    /// Check if metal recommendations are available
    var hasMetalRecommendations: Bool {
        return metals != nil && !metals!.isEmpty
    }
