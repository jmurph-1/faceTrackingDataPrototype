...
struct DefaultSeasonView: View {
    ...
    private var modulesGridView: some View {
        LazyVGrid(columns: [GridItem(.flexible()), GridItem(.flexible())], spacing: 24) {
            ...
            moduleCard("Characteristics", icon: "person.crop.rectangle.fill", color: primaryColor)
            moduleCard("Palette Breakdown", icon: "paintpalette.fill", color: primaryColor)
            moduleCard("Sister Palettes", icon: "square.grid.3x2.fill", color: primaryColor)
            moduleCard("Styling Guide", icon: "tshirt.fill", color: primaryColor)
            moduleCard("Colors to Avoid", icon: "xmark.diamond.fill", color: primaryColor)
        }
